...
def Bayes_classifier(number_sick,number_healthy,Probability_sick,Probability_healthy,List_param,List_other_param,List_Rez):
    ...
    Result_Vocabluary={'List_Age':0,'List_Har':0,'List_VG':0,'List_YH':0,'List_YS':0,'List_Card':0,'List_MaxP':0,'List_StepTest':0,'List_Sklon':0,'List_Sosyd':0,'List_Sps':0,'List_Sten':0}

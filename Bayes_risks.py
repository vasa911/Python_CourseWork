...
def Bayes_classifier_risks(Probability_sick,Probability_healthy,Result_Dictionary,PathOfFile):
    ...
    for stroka in li:
        ...
        print " наличие стенокардии в анамнезе=",Person_Sten
        ...
        List_Person_Paramets=[Person_Age, Person_Har,Person_VG,Person_YH,Person_YS,Person_MaxP, Person_StepTest,Person_Sklon,Person_Sosyd,Person_SPS,Person_Pol,Person_Sten]
        #Список названий параметров
        Keys_param=('List_Age','List_Har','List_VG','List_YH','List_YS','List_MaxP','List_StepTest','List_Sklon','List_Sosyd','List_Sps','List_Pol', 'List_Sten')
